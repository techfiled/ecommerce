    ...
    <div class="swiper-slide">
      ...
      <div class="product-item">
        <div class="image-holder">
          <img src="admin/<%= rs.getString("file") %>" alt="collection item" class="product-image" style="height: 30%;">
        </div>
        ...
        <div class="item-price text-primary">
          <span class="item-price text-primary"><%= rs.getString("prod_price") %></span>
        </div>
      </div>
      <% 
          }
